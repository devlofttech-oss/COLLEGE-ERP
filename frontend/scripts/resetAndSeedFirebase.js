...
const schemas = {
  ...
  users: ['uid', 'name', 'email', 'role', 'roleId', 'displayId', 'collegeIds', 'status', 'linkedStudentRecordIds', 'linkedStudentIds', 'createdAtText'],
...
const seed = {
  ...
  users: {
    ...
    'seed-admin-user': { uid: 'seed-admin-user', name: 'ERP Admin', email: 'admin@college.edu', role: 'admin', roleId: 'admin', displayId: 'ADM-001', collegeIds: ['main-campus'], status: 'active', linkedStudentRecordIds: [], linkedStudentIds: [], createdAtText: '19 Jun 2026' },
    'seed-parent-user': { uid: 'seed-parent-user', name: 'Rajesh Sharma', email: 'parent.vivek@example.com', role: 'parent', roleId: 'parent', displayId: 'PAR-001', collegeIds: ['main-campus'], status: 'active', linkedStudentRecordIds: ['seed-student-vivek'], linkedStudentIds: ['seed-student-vivek'], createdAtText: '19 Jun 2026' },
  },
  departments: {
